...
$string['lms2_launcher_url'] = 'LMS-2 Launcher URL';
$string['lms2_launcher_url_desc'] = 'URL of the aicc_use plugin launcher on LMS-2 (e.g., http://localhost:8301/lms-two/local/aicc_use/launcher.php). Leave empty to use direct launch with placeholders.';
$string['launch_token_ttl'] = 'Launch Token TTL';
$string['launch_token_ttl_desc'] = 'The time-to-live (in seconds) for the launch tokens.';
